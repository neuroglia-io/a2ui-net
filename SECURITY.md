...
The [A2UI NET SDK](https://github.com/neuroglia-io/a2ui-net) team and community take security vulnerabilities very seriously. Responsible disclosure of security issues is greatly appreciated, and every effort will be made to acknowledge and address your findings.

To report a security issue:

- **Use the GitHub Security Advisory**: Please use the ["Report a Vulnerability"](https://github.com/neuroglia-io/a2ui-net/security/advisories/new) tab on GitHub to submit your report.
...
To ensure the security and stability of the [A2UI NET SDK](https://github.com/neuroglia-io/a2ui-net), consider the following best practices:
...
By adhering to these best practices, the security of workflows and applications built using the [A2UI NET SDK](https://github.com/neuroglia-io/a2ui-net) can be significantly enhanced, reducing the risk of vulnerabilities and ensuring the integrity and reliability of the workflows executed.

---

Thank you for contributing to the security and integrity of the [A2UI NET SDK](https://github.com/neuroglia-io/a2ui-net)!
