...
/// <summary>
/// Represents the input arguments for an <see cref="OrFunctionCall" />.
/// </summary>
[Description("Represents the input arguments for an OrFunctionCall.")]
[DataContract]
public sealed record OrFunctionArgs
{
