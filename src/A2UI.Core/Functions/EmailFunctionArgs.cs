...
/// <summary>
/// Represents the input arguments for an <see cref="EmailFunctionCall" />.
/// </summary>
[Description("Represents the input arguments for an EmailFunctionCall.")]
[DataContract]
public sealed record EmailFunctionArgs
{

    /// <summary>
    /// Gets the value to validate as an email address.
    /// </summary>
