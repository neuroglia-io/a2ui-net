...
/// <summary>
/// Represents a function call that checks whether a value matches a regular expression.
/// </summary>
[Description("Checks that the value matches a regular expression string.")]
[DataContract]
public sealed record RegexFunctionCall
    : FunctionCall<RegexFunctionArgs>
{

    /// <summary>
    /// Gets the name of the function.
    /// </summary>
    public const string FunctionName = "regex";
    ...
    /// </summary>
    [JsonIgnore]
    protected override JsonTypeInfo<RegexFunctionArgs> ArgumentsTypeInfo => JsonSerializationContext.Default.RegexFunctionArgs;
