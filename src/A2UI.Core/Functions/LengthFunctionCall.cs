...
/// <summary>
/// Represents a function call that checks string length constraints.
/// </summary>
[Description("Checks string length constraints.")]
[DataContract]
public sealed record LengthFunctionCall
    : FunctionCall<LengthFunctionArgs>
{
    ...
    /// </summary>
    [JsonIgnore]
    protected override JsonTypeInfo<LengthFunctionArgs> ArgumentsTypeInfo => JsonSerializationContext.Default.LengthFunctionArgs;
