...
/// <summary>
/// Represents a message that can be sent to create a new surface. This message can be used to request the creation of a new surface in the application, which can then be used to display components and interact with the user.
/// </summary>
