...
/// <summary>
/// Represents a component used to arrange other components in a column.
/// </summary>
[Description("Represents a component used to arrange other components in a column.")]
[DataContract]
    ...
    : Component
{
    ...
    public override string Type => ComponentType.Column;

    /// <summary>
    /// Gets the child components the column contains.
    /// </summary>
    [Description("The child components the column contains.")]
    [Required]
