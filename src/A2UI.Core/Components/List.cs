...
/// <summary>
/// Represents a component used to arrange other components in a list.
/// </summary>
[Description("Represents a component used to arrange other components in a list.")]
[DataContract]
    ...
    : Component
{
    ...
    public override string Type => ComponentType.List;

    /// <summary>
    /// Gets the child components the list contains.
    /// </summary>
    [Description("The child components the list contains.")]
    [Required]
    ...
    /// <summary>
    /// Gets the direction in which the list arranges its children, if any.
    /// </summary>
    [Description("The direction in which the list arranges its children, if any.")]
    [DataMember(Order = 5, Name = "direction"), JsonPropertyOrder(5), JsonPropertyName("direction")]
